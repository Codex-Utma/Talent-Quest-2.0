...
export default function GptChat() {
  ...
  const handleSendMessage = () => {
    if (message.trim() !== "") {
      ...
      setTimeout(() => {
        const aiResponse: { sender: "user" | "ai"; text: string } = { sender: "ai", text: "Esta es una respuesta simulada." };
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-white shadow-lg rounded-lg w-80 p-4 border border-gray-300">
      ...
      <div className="mt-2 h-40 overflow-y-auto border border-gray-200 p-2 rounded bg-gray-50">
        {chat.map((msg, index) => (
          <div
            key={index}
