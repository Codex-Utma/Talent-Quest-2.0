        ...
        <div className="flex flex-col p-8 bg-transparent">
            ...
            <div className="py-10">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <h2 className="text-sm font-medium text-gray-700 mb-2">Cursos Asociados</h2>
                        <div className="flex items-center mb-2">
                            <input type="checkbox" className="mr-2" />
                            <label className="text-sm">Desarrollo Web Frontend</label>
                        </div>
                        <div className="flex items-center mb-2">
                            <input type="checkbox" className="mr-2" />
                            <label className="text-sm">Desarrollo Web Backend</label>
                        </div>
                        <div className="flex items-center mb-2">
                            <input type="checkbox" className="mr-2" />
                            <label className="text-sm"> Diseño de Interfaces</label>
                        </div>
                        <div className="flex items-center mb-2">
                            <input type="checkbox" className="mr-2" />
                            <label className="text-sm">Marketing Digital</label>
                        </div>
                        <div className="flex items-center mb-2">
                            <input type="checkbox" className="mr-2" />
                            <label className="text-sm">Gestión de Proyectos</label>
                        </div>
                    </div>
